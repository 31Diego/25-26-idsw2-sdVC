# abrirPublicaciones — Diseño · Coordinador
...
Recuperar y mostrar el listado completo de publicaciones del sistema (título, autor, fecha). Comportamiento idéntico al del investigador; la URL es compartida.
